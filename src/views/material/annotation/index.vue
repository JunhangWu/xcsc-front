            ...
            >
              ...
              <div class="material-info">
                ...
                <div class="material-status">
                  <el-tag 
                    :type="getStatusTagType(material.status)"
                    size="small"
                  >
                ...
                <div class="material-actions">
                  <el-button 
                    type="primary" 
                    size="small" 
                    @click.stop="showMaterialDetail(material)"
                    icon="Edit"
                  >
        ...
        <div class="annotation-info">
          ...
          <div class="annotation-section">
            ...
            <div style="margin-bottom: 20px; display: flex; justify-content: flex-end;">
              <el-button 
                @click="handleAIAutoTagging" 
                :type="isAIAutoTagging ? 'default' : 'primary'" 
            ...
            <el-form :model="autoTagForm" label-width="120px">
              ...
              <el-form-item label="素材描述">
                <el-input v-model="autoTagForm.materialDescription" type="textarea" placeholder="请输入素材描述"></el-input>
              </el-form-item>
            </el-form>
          </div>
          ...
          <div class="annotation-section">
            ...
            <el-form :model="manualTagForm" label-width="120px">
              <el-form-item label="时间信息">
                <el-date-picker
                  v-model="manualTagForm.timeInfo"
                  type="datetime"
                  placeholder="选择日期时间"
...
// 网格视图样式
  ...
  .preview-video .el-icon, .preview-file .el-icon {
    font-size: 64px;
    margin-bottom: 16px;
    color: #909399;
  }
